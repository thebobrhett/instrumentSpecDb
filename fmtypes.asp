...
<title>Administer Flow Meter Types</title>
...
access = UserAccess("equipment","fmtypes",currentuser)
If access <> "none" Then
	...
	response.write "<td ID='headertd' style='width:60%;text-align:center;vertical-align:center'><h1/>Edit Flow Meter Types</td>"
	...
	If access = "write" Or access = "delete" Then
		response.write "<td ID='headertd' style='text-align:center'><a href='fmtypes.asp?record_id=-1&sort=" & sortkey & "&direction=" & sortdir & "' title='Add a new flow meter type record'>Add new record</a></td>"
	Else
		Response.Write "<td id='headertd'>&nbsp;</td>"
	End If
	response.write "<td id='headertd'>&nbsp;</td>"
	...
	Response.Write "<td id='headertd'><a href='fmtypes.asp?sort=fm_type_id&direction=DESC'>"
	response.Write "<img src='mdownarrow.gif' alt='DESC'></a></td>"
	Response.Write "<th style='font-size:8pt'>&nbsp;Flow Meter Type ID&nbsp;</th>"
	Response.Write "<td id='headertd'><a href='fmtypes.asp?sort=fm_type_id&direction=ASC'>"
	Response.Write "<img src='muparrow.gif' alt='ASC'></a></td></tr></table></th>"
	response.Write "<th id='mediumth'>"
	Response.Write "<table><tr>"
	Response.Write "<td id='headertd'><a href='fmtypes.asp?sort=fm_type_name&direction=DESC'>"
	response.Write "<img src='mdownarrow.gif' alt='DESC'></a></td>"
	Response.Write "<th style='font-size:8pt'>&nbsp;Flow Meter Type Name&nbsp;</th>"
	Response.Write "<td id='headertd'><a href='fmtypes.asp?sort=fm_type_name&direction=ASC'>"
	Response.Write "<img src='muparrow.gif' alt='ASC'></a></td></tr></table></th>"
	If access = "write" Or access = "delete" Then
	...
	sqlString = "SELECT * FROM flow_meter_types " & _
	...
	If access = "write" Or access = "delete" Then
		If recordid < 0 Then
			...
			If session("err") = "fm_type_name" Then
				If session("fm_type_name") <> "" Then
					response.write "<td id='mediumtd' style='background-color:red'><input type='text' name='fm_type_name' size='50' value='" & session("fm_type_name") & "'></td>"
				Else
					response.write "<td id='mediumtd' style='background-color:red'><input type='text' name='fm_type_name' size='50' value=''></td>"
				End If
			Else
				If session("fm_type_name") <> "" Then
					response.write "<td id='mediumtd'><input type='text' name='fm_type_name' size='50' value='" & session("fm_type_name") & "'></td>"
				Else
					response.write "<td id='mediumtd'><input type='text' name='fm_type_name' size='50' value=''></td>"
				End If
			End If
			...
			Response.Write "<td id='mediumtd' style='text-align:center'><a href='fmtypes.asp?sort=" & sortkey & "&direction=" & sortdir & "' title='Cancel changes to this record'>Cancel</a></td>"
	...
	Do While Not rs.EOF
		Response.Write "<tr>"
		If CLng(rs("fm_type_id")) = CLng(recordid) Then
			'Draw the data entry line
			response.write "<td id='mediumtd'>" & rs("fm_type_id") & "</td>"

			If session("err") = "fm_type_name" Then
				If session("fm_type_name") <> "" Then
					response.write "<td id='mediumtd' style='background-color:red'><input type='text' name='fm_type_name' size='50' value='" & session("fm_type_name") & "'></td>"
				Else
					response.write "<td id='mediumtd' style='background-color:red'><input type='text' name='fm_type_name' size='50' value='" & rs("fm_type_name") & "'></td>"
				End If
			Else
				If session("fm_type_name") <> "" Then
					response.write "<td id='mediumtd'><input type='text' name='fm_type_name' size='50' value='" & session("fm_type_name") & "'></td>"
				Else
					response.write "<td id='mediumtd'><input type='text' name='fm_type_name' size='50' value='" & rs("fm_type_name") & "'></td>"
				End If
			End If
		...
		Else
			...
			response.write "<tr>"
			response.write "<td id='mediumtd'>" & rs("fm_type_id") & "</td>"
			If rs("fm_type_name") <> "" Then
				response.write "<td id='mediumtd'>" & rs("fm_type_name") & "</td>"
			Else
				Response.Write "<td id='mediumtd'>&nbsp;</td>"
			End If
			If access = "write" Or access = "delete" Then
				response.write "<td id='mediumtd'><a href='fmtypes.asp?record_id=" & rs("fm_type_id") & "&sort=" & sortkey & "&direction=" & sortdir & "' title='Edit this record'>Edit</a></td>"
			End If
			If access = "delete" Then
				recid = rs("fm_type_id")
				response.write "<td id='mediumtd'><a href='javascript:doDelete(" & recid & ");' title='Delete this record'>Delete</a></td>"
